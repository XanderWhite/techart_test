...
<section class="news-detail-section container">
    ...
    <div class="news-detail-section__content">
        <div class="article news-detail-section__content__block">
            <span class="news-item__date"><?= date('d.m.Y', strtotime($news->date)); ?></span>
            <div class="news-item__title active">
                <?= $news->announce; ?>
            </div>
            <div class="news-item__text"><?= $news->content; ?></div>
            <a class="news-item__link" href=<?= $_GET['return_url'] ?? '/' ?> >
            <svg class="news-item__link__svg svg-reverse" viewBox="0 0 27.004 13.322">
